...
if __name__ == '__main__':
    ...
    error1 = ''
    error5 = ''
    print("[INFO] loading resnet152...")
    model = resnet152_model("./resnet152_weights_tf.h5")
    #model.summary()
    ...
    of1 = open("./record/resnet152_error1.txt",'w')
    of2 = open("./record/resnet152_error5.txt",'w')
    of1.write(error1)
    of1.close()
    of2.write(error5)
    of2.close()
